...
if __name__=="__main__":
    ...
    run_main(trainingImages, testingImages, trainingLabels, testingLabels, pixelsize, iterations, foregroundbackgroundgratio, borderWeightFactor, borderWeightSigmaPx, sigma1Px, outDir)
